    ...
    return (
        <div className='Block5'>
            ...
            <div className='arrows'>
                <img src='../../../public/icons/Arrow%202.png' alt='arrowRight' onClick={() => paginate(currentPage - 1)} style={{ opacity: currentPage === 1 ? 0.5 : 1, cursor: currentPage === 1 ? '' : 'pointer' }} />
                <img src='../../../public/icons/Arrow%201.png' alt='arrowLeft' onClick={() => paginate(currentPage + 1)} style={{ opacity: indexOfLastComment >= totalComments ? 0.5 : 1, cursor: indexOfLastComment >= totalComments ? '' : 'pointer' }} />
            </div>
